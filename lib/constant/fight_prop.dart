...
enum FightPropType {
  ...
  final int value;
  const FightPropType(this.value);
  static FightPropType stringToEnum(String str) {
    switch (str) {
      ...
      default:
        throw Exception('Unknown enum string: $str');
    }
  }

  static FightPropType fromValue(int value) {
    return FightPropType.values.firstWhere((e) => e.value == value, orElse: () => FightPropType.FIGHT_PROP_NONE);
  }
}

const Map<FightPropType, IconData> fightPropToShow = {
  FightPropType.FIGHT_PROP_MAX_HP: FightProp.fight_prop_hp,
  FightPropType.FIGHT_PROP_CUR_ATTACK: FightProp.fight_prop_attack,
  FightPropType.FIGHT_PROP_CUR_DEFENSE: FightProp.fight_prop_defense,
  FightPropType.FIGHT_PROP_ELEMENT_MASTERY: FightProp.fight_prop_element_mastery,
  FightPropType.FIGHT_PROP_CRITICAL: FightProp.fight_prop_critical,
  FightPropType.FIGHT_PROP_CRITICAL_HURT: FightProp.fight_prop_critical_hurt,
  FightPropType.FIGHT_PROP_CHARGE_EFFICIENCY: FightProp.fight_prop_charge_efficiency,
};

const Map<FightPropType, IconData> dmgBonusPropToIcon = {
  FightPropType.FIGHT_PROP_FIRE_ADD_HURT: FightProp.fight_prop_fire_add_hurt,
  FightPropType.FIGHT_PROP_ELEC_ADD_HURT: FightProp.fight_prop_elec_add_hurt,
  FightPropType.FIGHT_PROP_WATER_ADD_HURT: FightProp.fight_prop_water_add_hurt,
  FightPropType.FIGHT_PROP_GRASS_ADD_HURT: FightProp.fight_prop_grass_add_hurt,
  FightPropType.FIGHT_PROP_WIND_ADD_HURT: FightProp.fight_prop_wind_add_hurt,
  FightPropType.FIGHT_PROP_ROCK_ADD_HURT: FightProp.fight_prop_rock_add_hurt,
  FightPropType.FIGHT_PROP_ICE_ADD_HURT: FightProp.fight_prop_ice_add_hurt,
  FightPropType.FIGHT_PROP_PHYSICAL_ADD_HURT: FightProp.fight_prop_physical_add_hurt,
  FightPropType.FIGHT_PROP_HEAL_ADD: FightProp.fight_prop_heal_add,
  FightPropType.FIGHT_PROP_HEALED_ADD: FightProp.fight_prop_healed_add,
};

const Map<FightPropType, IconData> statsPropToIcon = {
  FightPropType.FIGHT_PROP_FIRE_ADD_HURT: FightProp.fight_prop_fire_add_hurt,
  FightPropType.FIGHT_PROP_ELEC_ADD_HURT: FightProp.fight_prop_elec_add_hurt,
  FightPropType.FIGHT_PROP_WATER_ADD_HURT: FightProp.fight_prop_water_add_hurt,
  FightPropType.FIGHT_PROP_GRASS_ADD_HURT: FightProp.fight_prop_grass_add_hurt,
  ...
  FightPropType.FIGHT_PROP_ICE_ADD_HURT: FightProp.fight_prop_ice_add_hurt,
  FightPropType.FIGHT_PROP_PHYSICAL_ADD_HURT: FightProp.fight_prop_physical_add_hurt,
  FightPropType.FIGHT_PROP_HP: FightProp.fight_prop_hp,
  FightPropType.FIGHT_PROP_HP_PERCENT: FightProp.fight_prop_hp_percent,
  FightPropType.FIGHT_PROP_BASE_ATTACK: FightProp.fight_prop_base_attack,
  FightPropType.FIGHT_PROP_ATTACK: FightProp.fight_prop_attack,
  FightPropType.FIGHT_PROP_ATTACK_PERCENT: FightProp.fight_prop_attack_percent,
  FightPropType.FIGHT_PROP_DEFENSE: FightProp.fight_prop_defense,
  FightPropType.FIGHT_PROP_DEFENSE_PERCENT: FightProp.fight_prop_defense_percent,
  FightPropType.FIGHT_PROP_CRITICAL: FightProp.fight_prop_critical,
  FightPropType.FIGHT_PROP_CRITICAL_HURT: FightProp.fight_prop_critical_hurt,
  FightPropType.FIGHT_PROP_ELEMENT_MASTERY: FightProp.fight_prop_element_mastery,
  FightPropType.FIGHT_PROP_CHARGE_EFFICIENCY: FightProp.fight_prop_charge_efficiency,
