...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Create a login function that can be reused
    void performLogin() async {
      if (authState is AsyncLoading) return; // Don't do anything if already loading
      ...
      if (_formKey.currentState?.validate() ?? false) {
        ...
        if (context.mounted) {
          final fromPath = GoRouter.of(context).routeInformationProvider.value.uri.queryParameters['from'];
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          UniformTextFormField(
                              ...
                              onFieldSubmitted: (_) => performLogin(), // Call login when Enter is pressed on this field
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                              ...
                              icon: SizedBox(
                                  ...
                                  child: Icon(Icons.key,
                                      ...
                                      color: Theme.of(context).colorScheme.primary))),
                          TextButton(
                              onPressed: authState is AsyncLoading ? null : performLogin, // Use the same login function
                              style: ButtonStyle(
                                            ...
                                            content: defaultTargetPlatform == TargetPlatform.iOS ||
                                                ...
                                                ? CupertinoTextFormFieldRow(
                                                    ...
                                                    prefix: Icon(Icons.alternate_email,
                                                        color: Theme.of(context).colorScheme.primary),
                                                    style: TextStyle(
                                                        color: Theme.of(context).extension<TextColors>()!.text))
                                                : UniformTextFormField(
                                                    padding: EdgeInsets.zero,
                                                    controller: passwordResetController,
                                                    keyboardType: TextInputType.emailAddress,
