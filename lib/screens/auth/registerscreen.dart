        ...
        children: [
          Container(
              decoration: const BoxDecoration(
                  image:
                      DecorationImage(image: AssetImage('assets/images/951218.jpg'), fit: BoxFit.cover, opacity: 0.8)),
              ...
              children: [
                AsyncTextFormField(
                  ...
                  validator: (value) async {
                    try {
                      await ref.read(getNameProvider(value).future);
                      return false;
                    } catch (e) {
                      return true;
                    }
                ...
                AsyncTextFormField(
                  ...
                  validator: (value) async {
                    ...
                    if (regex.hasMatch(value)) {
                      try {
                        await ref.read(getEmailProvider(value).future);
                ...
                TextButton(
                    onPressed: () async {
                      ...
                      try {
                        await ref
                            .read(registerProvider(nameController.text, emailController.text, passwordController.text)
                                .future)
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text('Sign Up', style: Theme.of(context).textTheme.titleLarge!.copyWith(color: Colors.white)),
                      ],
                    )),
                Padding(
