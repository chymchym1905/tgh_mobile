...
class TableRowDpsDomain extends StatelessWidget {
  const TableRowDpsDomain({super.key, required this.dps, this.characterUsage, this.rank});
      ...
      children: [
        Padding(
            ...
            child: Row(children: [
              ...
              gameVersionColumnContent(context, dps.gameVersion),
              SizedBox(width: 10.wr),
              subCategoryColumnContent(context, dps.domain),
              SizedBox(width: 10.wr),
              nukerColumnContent(context, dps.dpsCharacter),
              SizedBox(width: 10.wr),
              if (MediaQuery.of(context).size.width > kMaxWidthMobile) ...[
