...
class SpeedrunEventFields extends ConsumerStatefulWidget {
  const SpeedrunEventFields({super.key, required this.updateSubmitInfo});
  final void Function(String key, dynamic value) updateSubmitInfo;

  @override
  ConsumerState<SpeedrunEventFields> createState() => _SpeedrunDomainState();
}

class _SpeedrunDomainState extends ConsumerState<SpeedrunEventFields> {
    ...
    return Column(mainAxisAlignment: MainAxisAlignment.start, children: [
      if (MediaQuery.of(context).size.width > 600) ...[
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(width: 10.wr),
          Expanded(flex: 1, child: eventField(context)),
        ]),
      ] else ...[
        regionField(context),
    ...
    return GestureDetector(
        ...
        child: SizedBox(
          ...
          child: DropdownSearch<String>(
              ...
              onChanged: (value) {
                widget.updateSubmitInfo('abyss_version', value);
              },
              autoValidateMode: AutovalidateMode.onUserInteraction,
              selectedItem: SUBMITABLE_EVENTS[0],
              decoratorProps: DropDownDecoratorProps(
                  baseStyle: const TextStyle(fontSize: 16),
                  decoration: InputDecoration(
                      labelText: 'Event',
