...
class DpsAbyssFields extends ConsumerStatefulWidget {
  const DpsAbyssFields({super.key, required this.updateSubmitInfo});
  final void Function(String key, dynamic value) updateSubmitInfo;

  @override
  ConsumerState<DpsAbyssFields> createState() => _DpsAbyssFieldsState();
}

class _DpsAbyssFieldsState extends ConsumerState<DpsAbyssFields> {
  ...
  Widget build(BuildContext context) {
    return Column(mainAxisAlignment: MainAxisAlignment.start, children: [
      if (MediaQuery.of(context).size.width > 600) ...[
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Expanded(flex: 2, child: videoLinkField(context)),
          SizedBox(width: 10.wr),
          Expanded(flex: 1, child: abyssFloorField(context)),
        ]),
        const SizedBox(height: 20),
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    return GestureDetector(
        ...
        child: SizedBox(
          ...
          child: DropdownSearch<String>(
              ...
              onChanged: (value) {
                widget.updateSubmitInfo('abyss_floor', value);
              },
              autoValidateMode: AutovalidateMode.onUserInteraction,
              selectedItem: ABYSS_FLOORS[0],
              decoratorProps: DropDownDecoratorProps(
  ...
  void dispose() {
    ...
    _abyssVersionController.dispose();
