...
class SpeedrunSection extends ConsumerStatefulWidget {
  const SpeedrunSection({super.key, required this.competitorId});
  final String competitorId;

  @override
  ConsumerState<SpeedrunSection> createState() => _SpeedrunSectionState();
}

class _SpeedrunSectionState extends ConsumerState<SpeedrunSection> {
        ...
        children: [
          speedruns.when(
            data: (data) {
              ...
              if (_init == false) _currentSpeedrunCategory = uniqueCategories[0];
                                                ...
                                                child: Column(
                                                  ...
                                                  InkWell(
                                                      ...
                                                      borderRadius: BorderRadius.only(
                                                          ...
                                                          bottomLeft:
                                                              e.accountSnapshot != null && e.accountSnapshot!.isNotEmpty
                                                      ...
                                                      child: Padding(
                                                          padding:
                                                              EdgeInsets.symmetric(vertical: 10.wr, horizontal: 10.wr),
                                                          child: Row(children: [
